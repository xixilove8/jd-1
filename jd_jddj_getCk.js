...
async function main() {
    ...
    $.deviceid_pdj_jd = '';
    $.jddjCookie = '';
    let deviceid = randomWord(false,40,40);
    $.token = deviceid;
    ...
    newJddjCKList[$.UserName] = {'ck':$.jddjCookie,'time':Date.now()};
    $.setdata(newJddjCKList, 'jddjCklist');
    console.log('**************');
