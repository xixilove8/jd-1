...
function getAuthorShareCode(url = "https://raw.fastgit.org/gitupdate/updateTeam/master/shareCodes/jxhb.json") {
  return new Promise(resolve => {
    const options = {
...
function taskurl(functionId, body = '', stk) {
  ...
  return {
    ...
    headers: {
      ...
      'Cookie': cookie,
      'accept': '*/*',
      'user-agent': `jdpingou;iPhone;5.7.0;14.4;${phoneId};network/4g;model/iPhone12,1;appBuild/100729;ADID/696F8BD2-0820-405C-AFC0-3C6D028040E5;supportApplePay/1;hasUPPay/0;pushNoticeIsOpen/0;hasOCPay/0;supportBestPay/0;session/507;pap/JA2019_3111789;brand/apple;supportJDSHWK/1;Mozilla/5.0 (iPhone; CPU iPhone OS 14_6 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148`,
      'accept-language': 'zh-cn',
      'referer': 'https://wqactive.jd.com/cube/front/activePublish/step_reward/525597.html?aid=525597',
    }
  }
}
